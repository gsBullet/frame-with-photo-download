      ...
      <div className="card frameHeader">
        <div className="card-header">
          <h1 className="text-light text-center fw-bold">
            আহলান সাহলান মাহে রমাদান <br />
            রমাদানকে স্বাগত জানিয়ে প্রোফাইল ফ্রেম
          </h1>
        </div>
      </div>
                ...
                <div className="card-body shadow h-100">
                  <div className="photo-frame-1">
                    ...
                    <img
                      ...
                      src="./img/Ramadanframe24.png"
                      alt=""
                    />
                    <h3 className="text-center fs-3 fw-bold text-light w-100 py-1 nameObject d-none">
                      {name}
                    </h3>
                  </div>
                </div>
